...
public class IntensifyLootTableProvider extends LootTableProvider {
    ...
    public static class ItemLootTables implements LootTableSubProvider {
        ...
        public void generate(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
            ResourceLocation strengtheningTableId =
                                            ...
                                            .add(
                                                    LootItem.lootTableItem(
                                                            ItemRegistry.STRENGTHENING_STONE
                                                                    .get())));
            consumer.accept(strengtheningTableId, strengtheningTable);

            ResourceLocation enengTableId =
                    new ResourceLocation(
            ...
            consumer.accept(enengTableId, enengTable);
        }
    }
}
